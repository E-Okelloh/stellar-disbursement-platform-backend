...
const styles = `
  ...
  .landing-root h1, .landing-root h2, .landing-root h3, .landing-root h4 {
    margin: 0; font-weight: 700; letter-spacing: -0.01em; font-family: var(--font-heading);
  }
  ...
  .landing-root .brand .accent { color: var(--green-700); }
  ...
  .landing-root .btn-primary { background: var(--green-600); color: #fff; box-shadow: 0 1px 2px rgba(6,130,65,0.15); }
  .landing-root .btn-primary:hover { background: var(--green-700); transform: translateY(-1px); }
  .landing-root .btn-ghost { background: transparent; color: var(--green-800); border-color: var(--border); }
  .landing-root .btn-ghost:hover { background: var(--green-50); }
  .landing-root .btn-light { background: #fff; color: var(--green-800); }
  .landing-root .btn-light:hover { background: var(--green-50); }
  ...
  .landing-root .stat b { display: block; font-size: 1.6rem; color: var(--ink); font-weight: 700; font-family: var(--font-heading); }
  ...
  .landing-root .corridor h4 { font-size: 0.98rem; color: var(--ink); margin: 0; font-family: var(--font-heading); font-weight: 700; }
  ...
  .landing-root .map-card .founded b { color: #fff; font-size: 2.4rem; display: block; margin-top: 4px; letter-spacing: 0; font-weight: 700; font-family: var(--font-heading); }
  ...
  .landing-root .platform-band h2 { font-size: 1.6rem; max-width: 30ch; font-weight: 700; color: #fff; }
  ...
  .landing-root .contact-item .icon {
    ...
    background: none; color: var(--green-700);
    display: flex; align-items: center; justify-content: center; flex-shrink: 0;
  }
  .landing-root .contact-item h4 { margin: 0; font-size: 0.92rem; color: var(--ink); font-family: var(--font-heading); font-weight: 700; }
  ...
  .landing-root footer { background: #17301f; color: rgba(255,255,255,0.82); padding: 64px 0 32px; }
  ...
  .landing-root .footer-brand { display: flex; align-items: center; gap: 10px; font-weight: 700; color: #fff; font-size: 1.1rem; margin-bottom: 14px; font-family: var(--font-heading); }
      ...
      <header>
        <div className="wrap nav">
          <a href="#top" className="brand">
            <span>
              SAP<span className="accent">CONE</span>
